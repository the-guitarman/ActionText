...
In fact, you want your Strings to behave as if they were <em>Texts<em>! A Text is not just an array of characters
...
Copyright (c) 2011 Maximilian Stroh. See LICENSE.txt for
further details.
